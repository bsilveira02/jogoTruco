...
public class Jogo {
    ...
    public void distribuirCartas() {
        ...
        InteracaoUsuario.exibeCartaVirada(cartaVirada);
    ...
    private Carta jogada(int index, Carta cartaMesa) {
        ...
        InteracaoUsuario.exibeCartaJogada(jogadores.get(index).nome, carta);
        return carta;
    }
    ...
    private void defineVencedorETrocaOrdemParaProximaRodada(Rodada rodada) {
        ...
        InteracaoUsuario.vencedorRodada(rodada.ganhador, jogadores.get(0), jogadores.get(1));
